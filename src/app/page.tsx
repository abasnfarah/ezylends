      ...
      <div className="flex flex-col lg:flex-row justify-center items-center">
        <MaxWidthWrapper className="mb-6 md:mb-12 mt-14 md:mt-28 lg:mt-40 flex flex-col items-center justify-center text-center w-full lg:w-1/2">
          <div className="relative group">
            <Button className="absolute px-4 md:px-7 py-3 md:py-4 mt-4 md:mt-8 mb-4 md:mb-8 -inset-0.5 bg-gradient-to-r from-green-600 to-cyan-600 blur opacity-75 group-hover:opacity-100 transition duration-150 ease-in-out" />
            <Button className="relative px-4 md:px-7 py-3 md:py-4 mt-4 md:mt-8 mb-4 md:mb-8 leading-none font-bold bg-black border border-zinc-800 flex items-center divide-x divide-gray-600 hover:bg-black">
              ...
              <span className="pl-4 md:pl-6 text-xs md:text-sm font-bold dark:text-red-600 text-green-950">
        ...
        <div className="w-full lg:w-1/2">
          <div className="mx-auto max-w-3xl lg:pt-8 px-6 lg:px-8">
            <div className="relative mt-16 flow-root sm:mt-24">
              {/* animated blobs*/}
              <div className="absolute top-0 -left-4 w-72 h-72 bg-destructive rounded-full mix-blend-lighten filter blur-2xl opacity-70 animate-blob" />
              <div className="absolute top-0 -right-4 w-72 h-72 bg-green-600 rounded-full mix-blend-lighten filter blur-2xl opacity-70 animate-blob animation-delay-2000" />
              <div className="absolute -bottom-8 right-20 w-72 h-72 bg-violet-600 rounded-full mix-blend-lighten filter blur-2xl opacity-70 animate-blob animation-delay-4000" />
